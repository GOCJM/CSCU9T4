...
public class CycleEntryTest {
    ...
    /**
     * Test of setTerrain method, of class Cycle.
     */
    @Test
    public void testSetTerrain() {
        System.out.println("getTerrain");
        Cycle instance = new Cycle("Alice", 1, 2, 2003, 0, 16, 7, 3, "asphalt", "moderate");
        String expResult = "dirt";
        instance.setTerrain("dirt");
        String result = instance.getTerrain();
        assertEquals(expResult, result);
    }
    ...
    /**
     * Test of setTempo method, of class Cycle.
     */
    @Test
    public void testSetTempo() {
        System.out.println("setTempo");
        Cycle instance = new Cycle("Alice", 1, 2, 2003, 0, 16, 7, 3, "asphalt", "moderate");
        String expResult = "fast";
        instance.setTempo("fast");
        String result = instance.getTempo();
        assertEquals(expResult, result);
    }
